...
export const reign_participants = pgTable("reign_participants", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "reign_participants_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const research_sources = pgTable("research_sources", {
...
export const books = pgTable("books", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "books_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	title: text().notNull(),
	subtitle: text(),
...
export const wrestlers = pgTable("wrestlers", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "wrestlers_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	legal_name: text(),
...
export const faction_members = pgTable("faction_members", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "faction_members_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const factions = pgTable("factions", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "factions_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	name: text().notNull(),
	type: text().notNull(),
	formed_year: integer(),
...
export const territories = pgTable("territories", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "territories_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	name: text().notNull(),
	short_name: text(),
	region: text(),
...
export const issue_cover_subjects = pgTable("issue_cover_subjects", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "issue_cover_subjects_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const periodical_issues = pgTable("periodical_issues", {
	...
	uniqueIndex("periodical_issues_periodical_id_profightdb_id_key").using("btree", table.periodical_id.asc().nullsLast(), table.profightdb_id.asc().nullsLast()),
	uniqueIndex("periodical_issues_periodical_id_publication_date_key").using("btree", table.periodical_id.asc().nullsLast(), table.publication_date.asc().nullsLast()),
	foreignKey({
...
export const pending_wrestlers = pgTable("pending_wrestlers", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "pending_wrestlers_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	profightdb_id: integer(),
	...
	index("idx_pending_wrestlers_resolved").using("btree", table.resolved_wrestler_id.asc().nullsLast()),
	uniqueIndex("pending_wrestlers_normalized_name_key").using("btree", table.normalized_name.asc().nullsLast()),
	uniqueIndex("pending_wrestlers_profightdb_id_key").using("btree", table.profightdb_id.asc().nullsLast()),
	foreignKey({
...
export const periodicals = pgTable("periodicals", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "periodicals_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	title: text().notNull(),
	publisher: text(),
	country: text(),
	language: text().default('English'),
...
export const ranking_entries = pgTable("ranking_entries", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "ranking_entries_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	...
	index("idx_ranking_entries_pending").using("btree", table.pending_wrestler_id.asc().nullsLast()),
	index("idx_ranking_entries_wrestler").using("btree", table.wrestler_id.asc().nullsLast()),
	uniqueIndex("ranking_entries_ranking_list_id_rank_key").using("btree", table.ranking_list_id.asc().nullsLast(), table.rank.asc().nullsLast()),
	foreignKey({
...
export const ranking_lists = pgTable("ranking_lists", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "ranking_lists_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	issue_id: integer().notNull(),
	...
	uniqueIndex("ranking_lists_issue_id_list_label_key").using("btree", table.issue_id.asc().nullsLast(), table.list_label.asc().nullsLast()),
	foreignKey({
...
export const reigns = pgTable("reigns", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "reigns_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const titles = pgTable("titles", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "titles_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	name: text().notNull(),
	status: text(),
	title_type: text(),
	weight_class: text(),
...
export const title_aliases = pgTable("title_aliases", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "title_aliases_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	title_id: integer().notNull(),
	name: text().notNull(),
	effective_from: text(),
	effective_to: text(),
	...
	unique("title_aliases_title_id_name_effective_from_key").on(table.title_id, table.name, table.effective_from),
]);
...
export const book_authors = pgTable("book_authors", {
	...
	uniqueIndex("book_authors_book_id_author_id_role_key").using("btree", table.book_id.asc().nullsLast(), table.author_id.asc().nullsLast(), table.role.asc().nullsLast()),
	foreignKey({
	...
	primaryKey({ columns: [table.book_id, table.author_id, table.role], name: "book_authors_pkey"}),
]);
export const v_reigns_full = pgView("v_reigns_full", {	reign_id: integer(),
	title_id: integer(),
	title_name: text(),
...
export const v_longest_reigns = pgView("v_longest_reigns", {	reign_id: integer(),
	title_name: text(),
	holder_display: text(),
	team_name: text(),
	reign_number: integer(),
...
export const v_issue_browser = pgView("v_issue_browser", {	id: integer(),
	...
	cover_subjects: text(),
}).as(sql`SELECT pi.id, p.title AS periodical, pi.publication_date, pi.period_date, pi.issue_number, pi.cover_image_url, pi.cover_description, pi.drive_pdf_path, ( SELECT count(*) AS count FROM ranking_lists WHERE ranking_lists.issue_id = pi.id) AS list_count, ( SELECT string_agg(COALESCE(w.primary_ring_name, ics.subject_name), ', '::text) AS string_agg FROM issue_cover_subjects ics LEFT JOIN wrestlers w ON ics.wrestler_id = w.id WHERE ics.issue_id = pi.id) AS cover_subjects FROM periodical_issues pi JOIN periodicals p ON pi.periodical_id = p.id`);

export const v_pending_wrestlers_queue = pgView("v_pending_wrestlers_queue", {	id: integer(),
	profightdb_id: integer(),
	profightdb_slug: text(),
	printed_name: text(),
	other_printed_names: text(),
